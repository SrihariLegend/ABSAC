...
fn main() {
    ...
    for name in &["h03_count_nonzero", "h04_count_masked_reversed", "h05_sum_int32",
                    "h06_all_zero", "h07_count_zero", "h08_count_above",
                    "n02_volatile_read", "n04_stride2", "n06_dependent", "n07_strlen"] {
