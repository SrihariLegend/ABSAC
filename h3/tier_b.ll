; ModuleID = 'h3/tier_b.c'
source_filename = "h3/tier_b.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@h3_g_a = external global [256 x i8], align 16
@h3_g_b = external local_unnamed_addr global [256 x i8], align 16
@h3_g_s = external local_unnamed_addr global [256 x i8], align 16

; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b01_any_or_global() local_unnamed_addr #0 {
  br label %4
...
4:                                                ; preds = %0, %4
  %5 = phi i64 [ 0, %0 ], [ %10, %4 ]
  %6 = phi i8 [ 0, %0 ], [ %9, %4 ]
  %7 = getelementptr inbounds [256 x i8], ptr @h3_g_a, i64 0, i64 %5
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b02_any_gt_global(i8 noundef zeroext %0) local_unnamed_addr #0 {
  br label %5
...
5:                                                ; preds = %1, %5
  %6 = phi i64 [ 0, %1 ], [ %13, %5 ]
  %7 = phi i8 [ 0, %1 ], [ %12, %5 ]
  %8 = getelementptr inbounds [256 x i8], ptr @h3_g_a, i64 0, i64 %6
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b03_any_eq_global(i8 noundef zeroext %0) local_unnamed_addr #0 {
  br label %5
...
5:                                                ; preds = %1, %5
  ...
  %13 = add nuw nsw i64 %6, 1
  %14 = icmp eq i64 %13, 256
  br i1 %14, label %2, label %5, !llvm.loop !12
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b04_any_lt_global(i8 noundef zeroext %0) local_unnamed_addr #0 {
  br label %5
...
define dso_local range(i64 0, 2) i64 @h3b05_ptr_scan(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #1 {
  %3 = icmp eq i64 %1, 0
...
define dso_local range(i64 0, 2) i64 @h3b06_volatile_load() local_unnamed_addr #2 {
  br label %4
...
4:                                                ; preds = %0, %4
  %5 = phi i64 [ 0, %0 ], [ %10, %4 ]
  %6 = phi i8 [ 0, %0 ], [ %9, %4 ]
  %7 = getelementptr inbounds i8, ptr @h3_g_a, i64 %5
...
define dso_local range(i64 0, 2) i64 @h3b07_store_in_loop(i8 noundef zeroext %0) local_unnamed_addr #3 {
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(256) @h3_g_b, i8 %0, i64 256, i1 false), !tbaa !5
  br label %5
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b08_two_loops() local_unnamed_addr #0 {
  br label %1

1:                                                ; preds = %0, %1
  %2 = phi i64 [ 0, %0 ], [ %7, %1 ]
  %3 = phi i8 [ 0, %0 ], [ %6, %1 ]
  %4 = getelementptr inbounds [256 x i8], ptr @h3_g_a, i64 0, i64 %2
...
14:                                               ; preds = %1, %14
  ...
  %16 = phi i8 [ %19, %14 ], [ 0, %1 ]
  %17 = getelementptr inbounds [256 x i8], ptr @h3_g_b, i64 0, i64 %15
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b09_reverse_scan() local_unnamed_addr #0 {
  br label %4
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b10_early_exit() local_unnamed_addr #0 {
  %1 = load i8, ptr @h3_g_a, align 16, !tbaa !5
  %2 = icmp eq i8 %1, 0
...
7:                                                ; preds = %3
  %8 = getelementptr inbounds [256 x i8], ptr @h3_g_a, i64 0, i64 %5
  %9 = load i8, ptr %8, align 1, !tbaa !5
  %10 = icmp eq i8 %9, 0
  br i1 %10, label %3, label %11, !llvm.loop !20

11:                                               ; preds = %7, %3
  %12 = icmp ult i64 %4, 255
  %13 = zext i1 %12 to i64
  br label %14
...
define dso_local range(i64 0, 2) i64 @h3b11_out_param(ptr nocapture noundef writeonly %0) local_unnamed_addr #4 {
  br label %2

2:                                                ; preds = %1, %9
  %3 = phi i64 [ 0, %1 ], [ %10, %9 ]
  %4 = getelementptr inbounds [256 x i8], ptr @h3_g_a, i64 0, i64 %3
  %5 = load i8, ptr %4, align 1, !tbaa !5
  %6 = icmp eq i8 %5, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i64 0, 2) i64 @h3b12_signed_lt_zero() local_unnamed_addr #0 {
  br label %4
...
4:                                                ; preds = %0, %4
  %5 = phi i64 [ 0, %0 ], [ %11, %4 ]
  %6 = phi i8 [ 0, %0 ], [ %10, %4 ]
  %7 = getelementptr inbounds [256 x i8], ptr @h3_g_s, i64 0, i64 %5
  %8 = load i8, ptr %7, align 1, !tbaa !5
  %9 = lshr i8 %8, 7
  %10 = or i8 %9, %6
