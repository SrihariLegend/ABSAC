; ModuleID = 'v10_corpus.c'
source_filename = "v10_corpus.c"
...
define dso_local i64 @p01_runtime_search_sentinel_n(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %1, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p02_runtime_search_sentinel_neg1(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %1, 0
  br i1 %3, label %12, label %4
...
12:                                               ; preds = %9, %4, %2
  %13 = phi i64 [ -1, %2 ], [ -1, %9 ], [ %5, %4 ]
  ret i64 %13
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p03_runtime_search_sentinel_nm1(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ne i64 %1, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p04_runtime_search_bool(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %1, 0
  br i1 %3, label %12, label %4
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p05_runtime_search_do_while(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
...
9:                                                ; preds = %4
  %10 = add nuw i64 %5, 1
  %11 = icmp eq i64 %10, %3
  br i1 %11, label %12, label %4, !llvm.loop !18
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p06_runtime_descending_search(ptr nocapture noundef readonly %0, i64 noundef %1) local_unnamed_addr #0 {
  br label %3
...
6:                                                ; preds = %3
  ...
  %9 = load i8, ptr %8, align 1, !tbaa !5
  %10 = icmp eq i8 %9, 0
  br i1 %10, label %3, label %11, !llvm.loop !19
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p07_search_then_sum(ptr nocapture noundef readonly %0, i64 noundef %1, i8 noundef zeroext %2) local_unnamed_addr #0 {
  %4 = icmp ne i64 %1, 0
...
8:                                                ; preds = %12
  ...
  %11 = icmp eq i8 %10, %2
  br i1 %11, label %16, label %12, !llvm.loop !20

12:                                               ; preds = %5, %8
  %13 = phi i64 [ %14, %8 ], [ 0, %5 ]
  %14 = add nuw i64 %13, 1
  %15 = icmp eq i64 %14, %1
  br i1 %15, label %21, label %8, !llvm.loop !20
...
24:                                               ; preds = %21, %24
  ...
  br i1 %32, label %22, label %24, !llvm.loop !21

33:                                               ; preds = %18, %22
  %34 = phi i64 [ %20, %18 ], [ %23, %22 ]
  ret i64 %34
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p08_const_search_wrong_sentinel(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  br label %2
...
7:                                                ; preds = %2
  ...
  %9 = icmp eq i64 %8, 32
  br i1 %9, label %10, label %2, !llvm.loop !22
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p09_const_search_32(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  br label %2
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p10_count_eq_const_64(ptr nocapture noundef readonly %0, i8 noundef zeroext %1) local_unnamed_addr #0 {
  br label %4
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p11_two_loops_const_48(ptr nocapture noundef readonly %0, i8 noundef zeroext %1) local_unnamed_addr #0 {
  br label %3
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define dso_local i64 @p12_sum_u8_const_96(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  br label %3
...
3:                                                ; preds = %1, %3
  ...
  br i1 %11, label %2, label %3, !llvm.loop !27
}
...
3:                                                ; preds = %1, %3
  ...
  %13 = icmp eq i64 %12, 64
  br i1 %13, label %2, label %3, !llvm.loop !31
}
...
3:                                                ; preds = %1, %3
  ...
  br i1 %12, label %2, label %3, !llvm.loop !32
}
...
3:                                                ; preds = %1, %3
  ...
  br i1 %11, label %2, label %3, !llvm.loop !33
}
...
3:                                                ; preds = %1, %3
  ...
  %10 = add nuw nsw i64 %5, 1
  %11 = icmp eq i64 %10, 32
  br i1 %11, label %2, label %3, !llvm.loop !34
}
...
5:                                                ; preds = %3, %5
  ...
  br i1 %15, label %4, label %5, !llvm.loop !35
}
...
8:                                                ; preds = %3
  %9 = load i64, ptr @g_sink, align 8, !tbaa !37
  %10 = add i64 %9, %4
  store i64 %10, ptr @g_sink, align 8, !tbaa !37
  br label %14

11:                                               ; preds = %3
  %12 = add nuw nsw i64 %4, 1
  %13 = icmp eq i64 %12, 48
  br i1 %13, label %14, label %3, !llvm.loop !39
...
6:                                                ; preds = %2, %6
  ...
  %13 = add nuw i64 %7, 1
  %14 = icmp eq i64 %13, %1
  br i1 %14, label %4, label %6, !llvm.loop !40
}
